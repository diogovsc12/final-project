...
class __TwigTemplate_09e927611d412668039218b33944014c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/seven/templates/classy/content-edit/filter-tips.html.twig", "D:\\Programas\\xampp\\htdocs\\drupal\\core\\themes\\seven\\templates\\classy\\content-edit\\filter-tips.html.twig");
    }
