...
class __TwigTemplate_8d3df3259ff97df3ecd66a4c3ac9c70d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/bootstrap/templates/input/input--button.html.twig", "D:\\Programas\\xampp\\htdocs\\drupal\\themes\\bootstrap\\templates\\input\\input--button.html.twig");
    }
